...
<div class="sidebar-container">
  <div class="sidebar-logo"><a href="" style="color: #fff" title="">Order Circle</a>
    
  </div>
  <ul class="sidebar-navigation">
    <li class="header"></li>
    <!-- <li>
      <a href="templates/add_order.php">
...
<div class="content-container">
  ...
  <div class="container-fluid">
    ...
    <h1></h1>
        <!-- <div class="card-header font-weight-bold"><h3>All Orders </h3></div> -->
...
<!--                   <th scope="col">Tracking ID</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $data['remaning_days']; ?></td>
                  </tr>
                <?php  }} ?>
                </tbody>
            </table>
