...
<div class="content-container">
  ...
  <div class="container-fluid">
    ...
    <h1></h1>
        <!-- <div class="card-header font-weight-bold "><h3 align="center">Complated Orders </h3></div> -->
    <!-- Main component for a primary marketing message or call to action -->
    <div class="jumbotron">
      <div class="card">
        <div class=" card-header">Fds</div>
        <div class="card-body">
...
<!--                   <th scope="col">Tracking ID</th>
              ...
              <tbody>
                  <?php
                     $select_all =" SELECT * FROM `orders` WHERE order_status='Ok Oredr'";
